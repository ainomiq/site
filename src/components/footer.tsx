...
// Payment method icons — inline SVG for maximum control & consistency
// All rendered as uniform 38×24px white-background pill cards
const PaymentIcons = () => (
  ...
  return (
    <footer className="border-t border-ainomiq-border">
      <div className="mx-auto max-w-6xl px-6 pt-16 pb-8">
        ...
        {/* Bottom */}
        <div className="mt-16 border-t border-ainomiq-border pt-8 space-y-5">
          {/* Payment icons */}
          <PaymentIcons />
