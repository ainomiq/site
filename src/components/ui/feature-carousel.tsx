...
export function FeatureCarousel() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto md:p-8">
      <div className="relative overflow-hidden rounded-[2rem] md:rounded-[2.5rem] lg:rounded-[4rem] flex flex-col lg:flex-row min-h-[500px] md:min-h-[600px] lg:min-h-0 lg:aspect-video">
        <div className="w-full lg:w-[40%] min-h-[280px] md:min-h-[450px] lg:h-full relative z-30 flex flex-col items-start justify-center overflow-hidden px-6 md:px-16 lg:pl-16 bg-[#3b82f6]">
